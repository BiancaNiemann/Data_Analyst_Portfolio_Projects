...
Each project reflects a unique business case and demonstrates my ability to work with data end-to-end—from cleaning and transformation to analysis and visualization.
...
I'm continuously learning and expanding my toolkit. Stay tuned for more projects involving advanced analytics, machine learning, and cloud-based data solutions.

Feel free to explore each project folder for detailed documentation, dashboards, and code!
